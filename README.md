...
- `GCP-USAGE.md` has instructions about how to create a new Pulumi Stack and a set of GCP resources for a new GCP virtual machine running NixOS.
- `CLAUDE.md` has detailed instructions for AI coding agents to understand this repository. Humans may find it useful too.
- `FILES_EXPLANATION.md` explains the more important files in this repo.
