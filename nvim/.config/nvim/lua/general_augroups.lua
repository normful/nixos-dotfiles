    ...
    javascript_augroup = {
      {
        'FileType',
        'javascript',
        [[map <buffer> <Leader>r <Cmd>AsyncRun -mode=term -focus=1 -pos=right -cols=70 node %<CR>]],
      },
    },
    ...
    typescript_augroup = {
      {
        'FileType',
        'typescript',
        [[map <buffer> <Leader>r <Cmd>AsyncRun -mode=term -focus=1 -pos=right -cols=70 ts-node %<CR>]],
      },
    },
