...
map({ 't', 'n' }, '<Localleader>t', function()
...
map('n', 'zl', 'zL', { desc = 'Scroll horizontally right (more)' })
map('n', 'zh', 'zH', { desc = 'Scroll horizontally left (more)' })
...
map('n', '<Leader>gb', '<Cmd>normful#GitBlame<CR><F15><CR>', { desc = 'git blame (fugitive)' })

map('n', '<Leader>gd', '<Cmd>Git diff<CR>', { desc = 'git diff' })

map('n', '<Leader>gw', '<Cmd>Git w<CR><CR><CR>', { desc = 'git stage all and commit' })
map('n', '<Leader>gsh', '<Cmd>Git show<CR><CR>', { desc = 'git show (fugitive)' })
map('n', '<Leader>gs', '<Cmd>Git status<CR>', { desc = 'git status (fugitive)' })
