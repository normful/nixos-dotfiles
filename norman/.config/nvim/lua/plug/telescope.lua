...
return {
  ...
  configure = configure,
  funcs = {
    git_or_find_files = git_or_find_files,
  },
  requires = {
    { 'nvim-lua/popup.nvim' },
    ...
    -- `brew install fzy` to install https://github.com/jhawthorn/fzy
    { 'nvim-telescope/telescope-fzy-native.nvim' },

    -- disabled because it's too slow compared to fzy
    -- `brew install fzf` to install https://github.com/junegunn/fzf
    -- { 'nvim-telescope/telescope-fzf-writer.nvim' },

    -- disabled because I don't like the results ordering
    -- { 'nvim-telescope/telescope-frecency.nvim', requires = { {'tami5/sql.nvim'} } },

    -- disabled because it doesn't seem useful
    -- { 'nvim-telescope/telescope-project.nvim' },

    { 'jvgrootveld/telescope-zoxide' },

    { 'normful/telescope-bookmarks.nvim' },
  },
}
