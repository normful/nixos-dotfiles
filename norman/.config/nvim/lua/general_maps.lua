...
utils.nnoremap_silent_bulk({
  -- Reload all lua and vimscript nvim config
  ['<Leader>r'] = string.format('<Cmd>lua dofile("%s")<CR><Bar><Cmd>source $MYVIMRC<CR>', globals.main_lua),

  -- Quick file editing
  ['<Leader>ev'] = '<Cmd>100vsplit ~/nixos-dotfiles/norman/.config/nvim/init.vim<CR>',
  ['<Leader>epl'] = '<Cmd>100vsplit ~/nixos-dotfiles/norman/.config/nvim/lua/plugins.lua<CR>',
  ['<Leader>es'] = '<Cmd>100vsplit ~/nixos-dotfiles/norman/.config/nvim/lua/general_settings.lua<CR>',
  ['<Leader>em'] = '<Cmd>100vsplit ~/nixos-dotfiles/norman/.config/nvim/lua/general_maps.lua<CR>',

  ['<Leader>eg'] = '<Cmd>100vsplit ~/.gitconfig<CR>',
  ['<Leader>ez'] = '<Cmd>100vsplit ~/.zshrc<CR>',
  ['<Leader>et'] = '<Cmd>100vsplit ~/.tmux.conf<CR>',

  ['<Leader>tl'] = '<Cmd>AsyncRun -mode=term -focus=1 -pos=curwin -cols=100 -strip ~/bin/tl<CR>',
  ['<Leader>epw'] = '<Cmd>100vsplit ~/.tmuxinator/my-workspace.yml<CR>',
  ...
  -- TODO(norman): Replace Karabiner-dependent mappings in NixOS
  ['<F15>'] = '<C-w>w',
